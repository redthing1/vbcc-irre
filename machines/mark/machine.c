 ...
 */
int freturn(struct Typ *t) { return R5; }
 ...
 */
int regok(int r, int t, int mode) { return 1; }
 ...
 */
int dangerous_IC(struct IC *p) { return 0; }
 ...
 *  the same registers.
 */
int must_convert(int o, int t, int const_expr) { return 0; }
...
void gen_code(FILE *f, struct IC *p, struct Var *v, zmax offset) {
    ...
    for (; p; p = p->next) {
        ...
        case ASSIGN:
            ...
            else if ((((p->q1.flags) & (KONST | VAR | REG | DREFOBJ | VARADR)) == KONST) && ((p->q1.val.vmax) == 0)) {
 ...
 * elements.
 */
int reg_pair(int r, struct rpair *p) { return 0; }
